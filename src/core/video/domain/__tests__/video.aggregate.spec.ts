...
describe('Video Unit Tests', () => {
  ...
  test('constructor of video', () => {
    ...
    const banner = new Banner('test name banner', 'test location banner');
    const thumbnail = new Thumbnail('test name thumbnail', 'test location thumbnail');
    const thumbnailHalf = new ThumbnailHalf('test name thumbnail half', 'test location thumbnail half');
  ...
  describe('create command', () => {
    test('should create a video and no publish video media', () => {
      ...
      const spyOnVideCreated = jest.spyOn(Video.prototype, 'onVideoCreated' as any);
