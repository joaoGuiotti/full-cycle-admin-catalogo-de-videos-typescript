...
export class VideoModelMapper {
  static toEntity(model: VideoModel) {
    ...
    const banner = bannerModel
      ? new Banner(bannerModel.name, bannerModel.location)
      : null;
    ...
    const thumbnail = thumbnailModel
      ? new Thumbnail(thumbnailModel.name, thumbnailModel.location)
      : null;
    ...
    const thumbnailHalf = thumbnailHalfModel
      ? new ThumbnailHalf(thumbnailHalfModel.name, thumbnailHalfModel.location)
      : null;
