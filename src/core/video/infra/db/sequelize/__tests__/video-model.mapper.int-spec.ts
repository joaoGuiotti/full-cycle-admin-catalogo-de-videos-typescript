  ...
  it('should convert a video model to a video entity', async () => {
    ...
    expect(entity.toJSON()).toEqual(
      new Video({
        ...
        is_published: videoProps.is_published,
        created_at: videoProps.created_at,
        banner: new Banner('name banner', 'location banner'),
        thumbnail: new Thumbnail('name thumbnail', 'location thumbnail',),
        thumbnail_half: new ThumbnailHalf('name thumbnail half', 'location thumbnail half'),
        trailer: new Trailer({
          name: 'name trailer',
          raw_location: 'raw_location trailer',
          encoded_location: 'encoded_location trailer',
