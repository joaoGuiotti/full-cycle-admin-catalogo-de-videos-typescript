...
import { GenreSearchParams, GenreSearchResult } from '../../../../../genre/domain/genre.repository';
...
describe('GenreSequelizeRepository Integration Tests', () => {
  ...
  it('should inserts a new a entity', async () => {
    const category = Category.fake().aCategory().build();
    await categoryRepo.insert(category);
    const genre = Genre.fake().aGenre()
  ...
  it('should finds a entity by id', async () => {
    ...
    expect(entityFound!.toJSON()).toStrictEqual(genre.toJSON());
  });
